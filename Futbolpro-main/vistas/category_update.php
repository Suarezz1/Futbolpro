...
<div class="container pb-6 pt-6">
	<?php
    	...
    	$check_categoria=$check_categoria->query("SELECT * FROM equipos WHERE id_equipo='$id'");
	...
	<form action="./php/categoria_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off" >
		...
		<label>Nombre</label>
		<input class="input" type="text" name="nombre_equipo" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{4,50}" maxlength="50" required value="<?php echo $datos['nombre_equipo']; ?>" >
